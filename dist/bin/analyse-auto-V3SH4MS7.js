...
async function performTriage(suggestions, confidenceGate, endpoint) {
  const triagePrompt = `You are a senior engineering lead triaging code suggestions. For each, decide: WORK, REVIEW, or DISMISS.

CRITERIA:
- WORK: Clear fix, well-defined, won't break anything.
- REVIEW: Good fix but has side effects a human should approve.
